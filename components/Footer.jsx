    ...
    <div>
      <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
        <div className="grid grid-flow-col gap-4">
          ...
          <a className="link link-hover">Our Reviews</a>
        </div>
        <div>
          <div className="grid grid-flow-col gap-4">
            <a  href="https://www.linkedin.com/in/marufahmed5480/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  width="24"
                height="24" className="fill-current">
        ...
        <div>
          <p>Copyright © 2022 - All right reserved by TASK</p>
        </div>
      </footer>
    </div>
  );
